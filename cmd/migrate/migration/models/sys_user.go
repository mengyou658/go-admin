...
type SysUser struct {
	...
	Phonenumber string    `json:"phonenumber" gorm:"type:varchar(11);comment:手机号"`
	...
	LoginIp     string    `json:"loginIp" gorm:"size:128;comment:邮箱"`
	LoginTime   time.Time `json:"loginTime" gorm:"size:128;comment:邮箱"`
